...
namespace UP2
{
    public partial class Form1 : Form, ISegment
    {
        ...
        public void PrintQuadrant(string text)
        {
            label5.Text = text;
        }
        ...
        private void DrawSegment()
        {
            ...
            _segment.UpdatePoint((float)numericUpDown1.Value,
                (float)numericUpDown4.Value,
                (float)numericUpDown2.Value,
                (float)numericUpDown3.Value
                );
            ...
            segment.Points.AddXY(_segment.A.X, _segment.A.Y);
            segment.Points.AddXY(_segment.B.X, _segment.B.Y);
